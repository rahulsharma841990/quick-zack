...
[![Version](https://img.shields.io/badge/Version-1.2.1-34d399?style=for-the-badge)](https://github.com)
...
| --------------------------------------------------------------- | ------------------------------------------- | ----- |
| [**QuickZack Setup 1.2.1.exe**](https://github.com/rahulsharma841990/quick-zack/releases/download/v1.2.1/QuickZack.Setup.1.2.1.exe)    | Full installer with Start Menu & auto-start | ~74MB |
| [**QuickZack-Portable-1.2.1.exe**](https://github.com/rahulsharma841990/quick-zack/releases/download/v1.2.1/QuickZack-Portable-1.2.1.exe) | No install needed, run anywhere             | ~73MB |
...
| Package                                                         | Description                                 | Size  |
| --------------------------------------------------------------- | ------------------------------------------- | ----- |
| [**QuickZack-1.2.1-arm64.dmg**](https://github.com/rahulsharma841990/quick-zack/releases/download/v1.2.1/QuickZack-1.2.1-arm64.dmg) | Apple Silicon (M1/M2/M3/M4)                 | ~93MB |
| [**QuickZack-1.2.1.dmg**](https://github.com/rahulsharma841990/quick-zack/releases/download/v1.2.1/QuickZack-1.2.1.dmg) | Intel Mac (x64)                             | ~100MB |
